var year_title = document.querySelector(".STARDUST1");
var title = document.querySelector(".STARDUST2");

var current_year = new Date().getFullYear()
year_title.appendChild(document.createTextNode(current_year))

var name1 = window.localStorage.getItem("name1")
var name2 = window.localStorage.getItem("name2")

const nodeName = document.createTextNode(`${name1} ❤ ${name2}`)
